...
class voDAO
{
    ...
    function __construct()
    {
        ...
        $this->setUsername($json_a["voDAO"]["username"]);
        $this->setPassword($json_a["voDAO"]["password"]);
        $this->setDatabase($json_a["voDAO"]["schema"]);
        $this->setHost($json_a["voDAO"]["host"]);
        $this->setPort($json_a["voDAO"]["port"]);
    }
}
