...
<!--		<script src="/js/highcharts.js"></script> -->
		...
		<!-- Custom charts -->
		<!-- Section one -->
		<script src="/js/wugms.chart.user.routerboard.qos.overview.js"></script>
		<script src="/js/wugms.chart.user.routerboard.qos.selected.js"></script>
		<script src="/js/wugms.chart.user.routerboard.qos.area.js"></script>
