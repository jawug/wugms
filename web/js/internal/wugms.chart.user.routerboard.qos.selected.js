                ...
                point: {
                    events: {
                        click: function() {
                            ...
                            $.getJSON("/content/wugms.chart.user.routerboard.qos.area.php?sel_ip=" + $sel_ip + "&sel_area=" + $sel_flow, function(json) {
...
////								}
    ...
    $.getJSON("/content/wugms.chart.user.routerboard.qos.selected.php", function(json) {
