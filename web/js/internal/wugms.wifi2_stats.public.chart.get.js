$(function() {
    var options = {
        chart: {
            ...
            renderTo: 'chart_wifi_frequency2',
        ...
        plotOptions: {
            ...
            series: {
                ...
                point: {
                    events: {
                        click: function() {
                            $('#cnd_table').bootstrapTable('refresh', { url: '/public/content/wugms.wifi_details.public.table.get.php?param=' + this.name + '&dataonly=true' });
                        }
                    }
                }
            }
    ...
    $.ajax({
        url: "/public/content/wugms.wifi_details.public.chart.get.php?freq=2",
        dataType: 'json',
