...
switch ($page_name) {
    ...
    case "wifistats":
        ...
        echo "});" . PHP_EOL;
        echo "</script>" . PHP_EOL;
        echo "<script src='/js/internal/wugms.wifi2_stats.public.chart.get.js'></script>" . PHP_EOL;
        echo "<script src='/js/internal/wugms.wifi5_stats.public.chart.get.js'></script>" . PHP_EOL;
        break;
    case "contactus":
        echo "<script>
            function reverse(s) {
