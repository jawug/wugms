			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<p><b>NOTE:</b> If there is no data then there is a chance that snmp data is not been collected from the device or not all devices have voltage, temperature or current sensors. </p>
					</div>
