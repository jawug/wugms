			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<p>The "selector" shows data for routerboards that are been polled via snmp. </p>
            ...
            <select data-placeholder="Select SSID..." class="chzn-select" style="width:350px;" id="cdn_select" name="cdn_select" >
               ...
               <?php
                  ...
                  foreach ($subresult as $row) {
                  	echo "<option value='" . $row['sn'] . "_" . $row['AP_ID'] . "'>". $row['SSID'] . " -> " . $row['sitename'] . "</option>";
                  }
                  ?>
            </select>
         </div>
