    ...
    $("#update_selection").click(function(){
		...
		$.ajax({
			...
			success: function(){
				...
				/* Update the device details section */
                $.getJSON("/content/wugms.user.routerboards.interface.details.php", function(json) {
			//		console.log(json.data);
$('#device_details').html("<table class='table'>" + json.data + "</table>");
                });
