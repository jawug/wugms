    ...
    function actionFormatter(value, row, index) {
        return [
            ...
            <?php if (isValueInRoleArray($_SESSION["roles"], "readonly")) { ?>            
                '<button id="editsitebtn" type="button" class="btn btn-primary edit disabled">Edit</button>',
                '<button id="deletesitebtn" type="button" class="btn btn-danger remove disabled">Delete</button>',
