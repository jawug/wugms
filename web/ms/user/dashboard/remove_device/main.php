			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Help - Device Graphs</h4>
					</div>
					<div class="modal-body">
						<p>The graphs on this page shows usage for the selected device. </p>
						<p>The "selector" shows routerboards and device where the user is either the owner or the equipment is located at the user's site. </p>
						<p>Note that not all devices have voltage, temperature or current sensors.</p>
					</div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="#">Router Device (Mikrotik) <span class='glyphicon glyphicon-dashboard' aria-hidden='true'></span></a></li>
...
ORDER BY b.SiteName, b.device_name;";
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" id="header">
			<div id="sel_device"> <?php if (isset($_SESSION["rb_des"])) { echo "<h3 class='sub-header'>Data for Routerboard device <span style='color: rgb(0, 0, 153);'>" . $_SESSION["rb_des"] . "</span></h3>"; } else { echo "<h3 class='sub-header'>No network device has been selected</h3> "; } ?></div>
			<div align="center">
				<div id="rb_volt" style="height: 400px; width: 100%; margin: 0 auto"></div>
				<hr>
				<div id="rb_temp" style="height: 400px; width: 100%; margin: 0 auto"></div>
				<hr>
				<div id="rb_current" style="height: 400px; width: 100%; margin: 0 auto"></div>
			</div>
		</div>
