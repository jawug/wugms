$(document).ready(function() {
    var options1 = {
        chart: {
            renderTo: 'interfaces_bytes_60min',
            type: 'spline',
			zoomType: 'x',
            marginBottom: 25
        },
...
//			floor: 0,
    ...
    $.getJSON("/content/snmp_interface_data.php?interval=60min", function(json) {
        options1.series = [{
            name : json[0].name,
            type : "spline",
/*            fillColor : {
...
/*            fillColor : {
        ...
        interfaces_bytes_60min_chart = new Highcharts.Chart(options1);		
