...
<!-- Delete site modal -->
 <div class="modal fade" id="DeleteSiteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true"> 
	...
	<div class="container-fluid">
		<div class="col-md-12"><h2>My Sites</h2></div>
		<div class="row">
			<div class="col-md-12" id="header">
				...
				<!-- Check if the user can add more sites -->
					<?php
						if  ($_SESSION["used_sites"] < $_SESSION["max_sites"])
							{
								...
								echo "<div class='alert alert-warning' role='alert'>You've used the maximum allocated sites <b>'" .$_SESSION["max_sites"] ."'</b> assigned for your site. Either delete a site not in use or else ask the admins to increase the maximum allocated sites for your account.</div>";
							}
					?>
					<br>
					<br>
...
<!--					<div class="panel-heading">
					...
					<div class="panel-body">
						<table id='user_accounts_table' data-url="/content/wugms.table.user.sites.php" data-toggle="table" data-classes="table table-hover" data-striped="true"  data-search="true" >
							<thead>
								<tr>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-info">
					<div class="panel-heading">
					<h2 class="panel-title"><b>Site changes</b></h2>
					</div>
					<div class="panel-body">
						<table id='user_accounts_table' data-url="/content/wugms.table.user.sites.audit.php" data-toggle="table" data-classes="table table-hover" data-striped="true" data-search="true" data-show-toggle="true" data-pagination="true" data-height="420" >
							<thead>
								<tr>
									<th data-formatter="runningFormatter">#</th>
