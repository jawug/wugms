		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-3 col-md-2 sidebar">
					...
					<li class="active"><a href="../interfaces"><img src="/images/network_wired.png" alt="..." class="img-rounded" width="24" height="24"> Interfaces </a></li>
					</ul>
				</div>
							...
							<div class="row vertical-align">
								...
								<?php 
									...
									if (isset($_SESSION["rb_iface_sel"])) {
										...
										echo "<input type='hidden' name='device_iface_init' id='device_iface_init' value=''>"; 
									}
								?>
				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" id="header">
					...
					<div class="panel panel-default">
						...
						<div id="device_details">
							<?php if (isset($_SESSION["rb_iface_config"])) { echo "<table class='table'>" . $_SESSION["rb_iface_config"] . "</table>"; } else { echo " "; } ?>
						</div>
					</div>
				</div>
			</div>
